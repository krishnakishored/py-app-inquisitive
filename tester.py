from  utils.io_handling import build_word_dict_from_file, display_keyvalue_pairs, swap_words_on_delimiter, word_trimmer
...
if __name__ == "__main__":
    ...
    file_in = './data/noun.txt'
    file_out = './data/noun_out.txt'
